    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-10">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-400 mt-1">Pilih dari berbagai varian dimsum lezat pilihan</p>
            </div>
            ...
            <div className="relative mb-6">
                ...
                <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-2xl focus:outline-none focus:border-[#C1121F] focus:ring-2 focus:ring-red-100 transition-all text-sm bg-gray-50"
                />
                {search && (
